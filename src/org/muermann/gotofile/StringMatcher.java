 ...
 */
/* package */
class StringMatcher implements ResourceMatcher
{
	...
	/* (non-Javadoc)
	 * @see org.muermann.gotofile.ResourceMatcher#select(org.eclipse.core.resources.IResource)
	 */
	public boolean match(IResource res)
	{
		return match( res.getName() );
	}
}
